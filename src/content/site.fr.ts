...
export const frContent: LandingPageContent = {
  ...
  footer: {
    ...
    legalLinks: [
      ...
      {
        links: [
          { label: 'Storyworth vs Life Story AI', href: '/fr/blog/storyworth' },
          { label: 'Comment écrire une autobiographie', href: '/fr/blog/how-to-write-an-autobiography?utm_source=Direct' },
        ],
      },
    ],
  },
