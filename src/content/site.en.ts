    ...
    legalLinks: [
      {
        links: [
          ...
          { label: 'Features', href: '#feature' },
          { label: 'Pricing', href: '#new-pricing' },
          { label: 'Privacy', href: 'https://life-story.ai/privacy-policy' },
          { label: 'Terms of service', href: 'https://life-story.ai/terms-of-service' },
        ],
      },
      {
        links: [
          ...
          { label: 'FAQ', href: '#faq' },
          { label: 'About us', href: 'https://life-story.ai/team' },
          { label: 'Vision', href: 'https://life-story.ai/vision' },
      ...
      },
      {
        title: 'See also',
        links: [
          { label: 'Gift a biography', href: 'https://life-story.ai/gift' },
          { label: 'Autobiography', href: 'https://life-story.ai/autobiography' },
          { label: 'Mother biography', href: 'https://life-story.ai/mother-biography' },
          { label: 'Family stories', href: 'https://life-story.ai/' },
